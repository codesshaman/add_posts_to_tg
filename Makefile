...
help:
	...
	@echo -e "$(WARN_COLOR)- make env				: 1. Create .env-file"
	@echo -e "$(WARN_COLOR)- make venv				: 2. Create virtual environment"
	@echo -e "$(WARN_COLOR)- make req				: 3. Install requirements"
	@echo -e "$(WARN_COLOR)- make				    	: 4. Application launch"
